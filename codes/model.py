...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma,
        ...
        if model_name == 'Ellipse3' or model_name == 'Ellipse3_sqrt':
    ...
    def Ring(self, head, relation, tail, mode):
        ...
        mass_ab = (hr - tr + 6 * (torch.cos(0.5 * tr) - torch.cos(0.5 * hr))).abs()
        mass_all = 2 * pi + 12
        mass = torch.where((hr - tr).abs() < pi, mass_ab, mass_all - mass_ab)
